        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DietitianProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MealLogs_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DietitianProfileId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_DietitianProfiles_DietitianProfileId",
                        column: x => x.DietitianProfileId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DietLists_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DietLists_AspNetUsers_DietitianId",
                        column: x => x.DietitianId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DietLists_DietitianProfiles_DietitianProfileId",
                        column: x => x.DietitianProfileId,
                        principalTable: "DietitianProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_AspNetUsers_DietitianId",
                        column: x => x.DietitianId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_DietitianProfiles_DietitianProfileId",
                        column: x => x.DietitianProfileId,
                        principalTable: "DietitianProfiles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_DietitianProfileId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DietitianProfiles_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DietLists_DietitianId",
                table: "DietLists",
                column: "DietitianId");

            migrationBuilder.CreateIndex(
                name: "IX_DietLists_DietitianProfileId",
                table: "DietLists",
                column: "DietitianProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_DietitianId",
                table: "Reviews",
                column: "DietitianId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_DietitianProfileId",
                table: "Reviews",
                column: "DietitianProfileId");
        }
